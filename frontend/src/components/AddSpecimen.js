        ...
        return (
            ...
            <div className="container h-100">
                        ...
                        <form id="addSpecimenForm" onSubmit={this.handleSubmit}>
                            <label>
                                <Row className={"addSpecimenForm"}>
                                    ...
                                    <Col className={"addSpecimenForm"}><input type="text" name="title" required={true}
                            ...
                            <label>
                                <Row className={"addSpecimenForm"}>
                                    <Col>State:</Col>
                                    <Col>
                                        <select className={"selectCondition"} name="condition"
                                                value={this.state.stateValue} onChange={this.handleStateChange}>
                            ...
                            <label>
                                <Row>
                                    ...
                                    <Col><input type="text" name="number_pages" required={true} className="form-control"
                                                id={"pages"}/></Col>
                            ...
                            <label>
                                <Row>
                                    <Col>Author:</Col>
                                    <Col><input type="text" name="author" required={true}
                                                className="form-control"/></Col>
                                </Row>
                            </label>
                            <br/>
                            <label>
                                <Row>
                                    <Col>ReleaseDate:</Col>
                                    <Col><input type="date" name="release_date" required={true} className="form-control"
                                                id={"ReleaseDate"}/></Col>
                            ...
                            <label>
                                <Row>
                                    ...
                                    <Col><input type="text" name="issue_number" required={true}
                                                className="form-control"/></Col>
                                </Row>
                            </label>
                            <br/>
                            <label>
                                <Row>
                                    <Col>ISBN:</Col>
                                    <Col><input type="text" name="isbn" required={true} className="form-control"/></Col>
                                </Row>
                            </label>
                            <br/>
                            <label>
                                <Row>
                                    ...
                                    <Col><input type="text" name="publishing_house" required={true}
                                                className="form-control"/></Col>
                                </Row>
                            </label>
                            <br/>
                            <label>
                                <Row>
                                    ...
                                    <br/>
                                    <Col><input type="checkbox" name={"readyForRenting"}
                                                onClick={this.handleRentalTimeStateChange}
                                                id={"ReadyForRentingCheckBox"}/>
                            ...
                            <label>
                                <Row>
                                    <Col>RentalTime:</Col>
                                    <Col><input id={"RentalTime"} className="form-control" type="number"
                                                name="loan_period" required={!this.state.rentalTimeDisabled}
                                                disabled={(this.state.rentalTimeDisabled) ? true : false}/></Col>
                            ...
                            <label>
                                <Row>
                                    <Col>Photo url:</Col>
                                    <Col><input type="text" name="photo_url" required={true} className="form-control"/></Col>
                                </Row>
                            </label>
                            <br/>
                ...
                <Container>
                    ...
                    <Row><Col className={"lastBookCol"} md={12}></Col></Row>
                </Container>
                <br/>
            </div>
